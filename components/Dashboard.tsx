      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 font-pixel relative">
        ...
        <div className="col-span-1 flex flex-col gap-6">
            ...
            <PixelCard className="flex flex-col items-center justify-center relative !bg-[#262626] !p-0 overflow-hidden group border-4 !border-[#111] min-h-[300px]">
                ...
                <div className="mt-10 mb-4 relative z-10 w-full flex flex-col items-center">
                    ...
                    <div className="relative w-48 h-48" style={{ minWidth: '192px', minHeight: '192px' }}>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center mt-1 pointer-events-none z-30">
                            <span className="text-5xl text-white text-shadow-lg font-bold">
                            {stats.total === 0 ? '0' : Math.round((stats.completed / stats.total) * 100)}%
                            </span>
                        </div>
                    </div>
                    <p className="text-mc-stoneLight text-xl uppercase mt-2 tracking-widest bg-black/50 px-2 rounded">Efficiency</p>
                </div>
